...
parser.add_argument('-dataset', type=str, default='train_smarthome_CS_51.json')
...
def run(models, criterion, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        for model, gpu, dataloader, optimizer, sched, model_file in models:
            ...
            prob_val, val_loss, val_map, index_dict, classAccuracy, ind_val_map_dict = val_step(model, gpu, dataloader['val'], epoch)
...
def val_step(model, gpu, dataloader, epoch):
    ...
    for data in dataloader:
        ...
        index_dict[other[0][0]] = indexArray

        ind_val_map = 100 * apm.value()
        ind_val_map_dict[other[0][0]] = ind_val_map
    ...
    apm.reset()
    return full_probs, epoch_loss, val_map, index_dict, classAccuracy, ind_val_map_dict
